...
End result for `encryptedURL` will look something like this:
...
const wrappedBuf = criptoe.toArrayBuffer(wk, Boolean("url"));
...
// Decrypt 🥳
const unencryptedMessage = await criptoe.decrypt(
  encryptedString,
  key,
  initVector,
);
